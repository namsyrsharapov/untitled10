...
public class HomeWork5 {
    ...
    */
    ...
    public static class Person {
        ...
        public Person(String name, int protection, int health) {
            this.name = name;
        ...
        public String announce() {
            return String.format("Person %s has the characteristics: %d health and %d protection", name, health, protection);
        }

        public void takeDamage(int damage) throws PersonDead {
    ...
    public static class Mage extends Person{
        ...
        public void takeDamage(int damage) throws PersonDead {
            ...
            int newHealth = health - (damage - protection - health % 10 + buff);
            if (newHealth <= 0) {
                throw new PersonDead();
            }
    ...
    public static class Archer extends Person{
        ...
        public void takeDamage(int damage) throws PersonDead {
            ...
            int newHealth = health - (damage - protection + health % 10 + debuff);
            if (newHealth <= 0) {
                throw new PersonDead();
            }
            super.takeDamage(damage);
